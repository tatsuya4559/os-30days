...
bootpack.hrb: bootpack.c font.h os.ld nasmfunc.o iolib.o graphic.o
	...
	gcc -march=i486 -m32 -fno-pic -nostdlib -T os.ld nasmfunc.o iolib.o graphic.o bootpack.c -o $@
